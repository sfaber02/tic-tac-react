...
const Board = () => {
  ...
  return (
    <div>
      ...
      <table id="table">
        <tr>
          <td id="00" onClick={(e) => handleClick(e)}></td>
          <td class="vert" id="01" onClick={(e) => handleClick(e)}></td>
          <td id="02" onClick={(e) => handleClick(e)}></td>
        </tr>
        <tr>
        ...
        <tr>
          <td id="20" onClick={(e) => handleClick(e)}></td>
          <td class="vert" id="21" onClick={(e) => handleClick(e)}></td>
          <td id="22" onClick={(e) => handleClick(e)}></td>
        </tr>
      </table>
      <h1 id="msgArea">{msgArea}</h1>
      <div id="thebutton">
        <button id="alsobutton" onClick={(e) => handleReset(e)}>
          Reset Game
        </button>
      </div>
    </div>
